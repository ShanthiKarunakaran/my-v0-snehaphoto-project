        ...
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-3 text-sm text-muted-foreground text-center px-4 max-w-2xl">
            <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1">
              ...
              <span>Copyright © <a href="https://github.com/ShanthiKarunakaran" onClick={handleOpenModal} className="text-primary hover:underline cursor-pointer">Shanthi Karunakaran</a></span>
              <span className="hidden sm:inline">—</span>
